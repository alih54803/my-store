<nav class="sb-topnav navbar navbar-expand  " style="background-color:	#48280FFD ">
    <!-- Navbar Brand-->
    ...
    <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
        ...
        @endcan
        @can('post-list')
        <li><a class="nav-link" href="{{ route('laptop_route.index') }}">Posts</a></li>
        @endcan

        @else

            <a href="{{url('/')}}">Hommmmmeeee </a>
            @if (Route::has('login'))
                <li class="nav-item">
